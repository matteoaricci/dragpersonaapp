...
matt = User.create(name: "Matteo Ricci", drag_name: "Auntie Depressant", city_id: 1, house_id: ed.id)
bri = User.create(name: "Bri Turner", drag_name: "Amy Bipolar", city_id: 1, house_id: ed.id)
carl = User.create(name: "Carl Parm", drag_name: "Lady Footlocker", city_id: 1, house_id: parm.id)
paul = User.create(name: "Paul Kim", drag_name: "Mona Lott", city_id: 1, house_id: parm.id)
